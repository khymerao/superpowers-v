...
- **внешние бэкенды на 3.x**: 0 прогонов даже на Codex через Engine C. *(Устарело 2026-09-11: Codex-джоба прошла через Engine C в 3.4.3 — см. CHANGELOG; сам Engine C с 3.0.3 прогнан более восьмидесяти раз на сборках этого репо, до пяти джоб в прогоне.)*
