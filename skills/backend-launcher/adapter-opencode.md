...
way a job's `test_scope` could reach a headless opencode worker was as a sentence inside
...
- It is **structurally validated before opencode is launched**. A malformed contract, an unknown key,
